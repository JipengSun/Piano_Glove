...
#define NRF_LOG_BACKEND_UART_RX_PIN (32+8)
// Faster than 38.4k occasionally drops parts of messages
#define NRF_LOG_BACKEND_UART_BAUDRATE NRF_UART_BAUDRATE_38400
